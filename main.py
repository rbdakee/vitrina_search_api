...
async def lifespan(app: FastAPI):
    ...
    # Пытаемся создать таблицы, но не падаем если БД недоступна
    # (таблицы должны быть созданы заранее через миграции или SQL скрипты)
    try:
        await init_db()
        ...
        logging.warning("Убедитесь, что таблицы созданы и БД доступна")
    yield
